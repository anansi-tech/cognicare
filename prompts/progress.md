...
- For each instrument, state direction (lower = improvement for PHQ-9/GAD-7; for wellbeing measures
  such as WHO-5, HIGHER = improvement and a low or falling score is the concern — a WHO-5 at or below
  the screening cutoff of 50% / raw 13 warrants further depression assessment) and whether the change
